...
from backfill_request_logs import (
    DEFAULT_CONFIG_PATH,
...
from postgres_to_mongo_request_log_sync import (
    DEFAULT_BATCH_SIZE,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--ids", default="", help="Comma-separated explicit request_log_id values to inspect.")
    parser.add_argument(
...
def inspect_by_time(
    ...
    while True:
        ...
        print_progress(scanned_rows, total_rows, missing_count, field_mismatch_count, last_request_log_id, batch_started_at)
...
def main() -> None:
    ...
    mongo_db_name = get_request_log_mongo_db_name(
        config,
