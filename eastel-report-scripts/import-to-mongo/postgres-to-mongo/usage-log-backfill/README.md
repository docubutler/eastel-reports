...
Use `inspect_usage_logs_sync.py` when you want to check whether Mongo
`usage_logs` still match PostgreSQL without writing any repair changes.

The inspection script accepts the same scope options as the backfill script:

- `--mode ids --ids 202170656,202170657`
- `--mode id_range --id-from 202000000 --id-to 203000000`
- `--mode time --time-field usage_update_time --start 2026-07-13T00:00:00 --end 2026-07-16T00:00:00`

Example:

```powershell
py .\inspect_usage_logs_sync.py --mode time --time-field usage_update_time --start 2026-07-13T00:00:00 --end 2026-07-16T00:00:00
```
